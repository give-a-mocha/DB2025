...
#include "execution/executor_group_aggregate.h"
   ...
   public:
            ...
            switch (x->tag) {
                ...
                case PlanTag::T_Update: {
                    ...
                    std::unique_ptr<AbstractExecutor> root = std::make_unique<MvccUpdateExecutor>(
                        std::move(scan), x->tab_name_, std::move(x->set_clauses_), context);
                ...
                case PlanTag::T_Delete: {
                    ...
                    std::unique_ptr<AbstractExecutor> root =
                        std::make_unique<MvccDeleteExecutor>(std::move(scan), std::move(x->tab_name_), context);
                ...
                case PlanTag::T_Insert: {
                    std::unique_ptr<AbstractExecutor> root =
                        std::make_unique<MvccInsertExecutor>(std::move(x->tab_name_), std::move(x->values_), context);
    ...
    std::unique_ptr<AbstractExecutor> convert_plan_executor(std::shared_ptr<Plan> plan, Context *context) {
        ...
        if (plan->tag == PlanTag::T_Projection) {
            ...
            std::unique_ptr<AbstractExecutor> left = convert_plan_executor(std::move(x->left_), context);
            std::unique_ptr<AbstractExecutor> right = convert_plan_executor(std::move(x->right_), context);
