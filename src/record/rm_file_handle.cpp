...
auto RmFileHandle::GetTupleWithLockAcquired(const Rid& rid, const char* page_data) const
...
auto RmFileHandle::UpdateTupleWithLockAcquired(const Rid& rid, TupleMeta& meta, char* buf, char* page_data) -> void {
